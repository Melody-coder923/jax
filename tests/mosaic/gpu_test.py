...
class MosaicGpuDialectTest(TestCase, jtu.JaxTestCase):
  ...
  @parameterized.parameters(
      ((128, 64), (128,), [1], jnp.float32, 5.0, 2.0, vector.CombiningKind.ADD),
      ((128, 64), (128,), [1], jnp.float32, 5.0, 2.0, vector.CombiningKind.MAXIMUMF),
      ((128, 64), (128,), [1], jnp.float32, 5.0, 7.0, vector.CombiningKind.MAXIMUMF),
      ((128, 64), (128,), [1], jnp.int32, 5, 2, vector.CombiningKind.MAXSI),
      ((128, 64), (128,), [1], jnp.int32, -5, -2, vector.CombiningKind.MAXSI),
      ((128, 64), (128,), [1], jnp.int32, -2, -5, vector.CombiningKind.MAXSI),
      ((128, 64), (128,), [1], jnp.uint32, 5, 2, vector.CombiningKind.MAXUI),
      ((128, 64), (128,), [1], jnp.uint32, 2, 5, vector.CombiningKind.MAXUI),
      #
  ...
  def test_vector_multi_dim_reduction(
    ...
    def body(ctx, result_gmem_ref, smem):
      ...
      c = arith.constant(el_type, el_value)
    ...
    source = np.full(input_shape, el_value, dtype=dtype)
